...
cd $apps_root
# rm -rf ./ASIMTracesCollection_A100
mkdir ./ASIMTracesCollection_A100

mkdir ./ASIMTracesCollection_A100/cublas_GemmEx_HF_CC
# mkdir ./ASIMTracesCollection_A100/cublas_GemmEx_HF_TC
# mkdir ./ASIMTracesCollection_A100/cusparse_spmm_csr_HF_CC
mkdir ./ASIMTracesCollection_A100/PolyBench
mkdir ./ASIMTracesCollection_A100/Rodinia
# mkdir ./ASIMTracesCollection_A100/sputnik_spmm_csr_HF_CC
# mkdir ./ASIMTracesCollection_A100/vectorSparse_spmm_csr_HF_TC
mkdir ./ASIMTracesCollection_A100/DeepBench
mkdir ./ASIMTracesCollection_A100/Tango
mkdir ./ASIMTracesCollection_A100/LULESH
mkdir ./ASIMTracesCollection_A100/PENNANT
mkdir ./ASIMTracesCollection_A100/PENNANT
mkdir ./ASIMTracesCollection_A100/pannotia
...
# mkdir ../ASIMTracesCollection_A100/cublas_GemmEx_HF_CC/128x128x128
# mv -f traces/* ../ASIMTracesCollection_A100/cublas_GemmEx_HF_CC/128x128x128

# echo $(date +%Y/%m/%d/%T)

# LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./cublas_GemmEx_HF_CC_example -m 256 -n 256 -k 256
# mkdir ../ASIMTracesCollection_A100/cublas_GemmEx_HF_CC/256x256x256
# mv -f traces/* ../ASIMTracesCollection_A100/cublas_GemmEx_HF_CC/256x256x256

# echo $(date +%Y/%m/%d/%T)

# LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./cublas_GemmEx_HF_CC_example -m 512 -n 512 -k 512
# mkdir ../ASIMTracesCollection_A100/cublas_GemmEx_HF_CC/512x512x512
# mv -f traces/* ../ASIMTracesCollection_A100/cublas_GemmEx_HF_CC/512x512x512

# echo $(date +%Y/%m/%d/%T)

# LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./cublas_GemmEx_HF_CC_example -m 1024 -n 1024 -k 1024
# mkdir ../ASIMTracesCollection_A100/cublas_GemmEx_HF_CC/1024x1024x1024
# mv -f traces/* ../ASIMTracesCollection_A100/cublas_GemmEx_HF_CC/1024x1024x1024

# echo $(date +%Y/%m/%d/%T)

LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./cublas_GemmEx_HF_CC_example -m 2048 -n 2048 -k 2048
mkdir ../ASIMTracesCollection_A100/cublas_GemmEx_HF_CC/2048x2048x2048
mv -f traces/* ../ASIMTracesCollection_A100/cublas_GemmEx_HF_CC/2048x2048x2048
...
# mkdir ../ASIMTracesCollection_A100/cublas_GemmEx_HF_TC/128x128x128
# mv -f traces/* ../ASIMTracesCollection_A100/cublas_GemmEx_HF_TC/128x128x128

# echo $(date +%Y/%m/%d/%T)

# LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./cublas_GemmEx_HF_TC_example -m 256 -n 256 -k 256
# mkdir ../ASIMTracesCollection_A100/cublas_GemmEx_HF_TC/256x256x256
# mv -f traces/* ../ASIMTracesCollection_A100/cublas_GemmEx_HF_TC/256x256x256

# echo $(date +%Y/%m/%d/%T)

# LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./cublas_GemmEx_HF_TC_example -m 512 -n 512 -k 512
# mkdir ../ASIMTracesCollection_A100/cublas_GemmEx_HF_TC/512x512x512
# mv -f traces/* ../ASIMTracesCollection_A100/cublas_GemmEx_HF_TC/512x512x512

# echo $(date +%Y/%m/%d/%T)

# LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./cublas_GemmEx_HF_TC_example -m 1024 -n 1024 -k 1024
# mkdir ../ASIMTracesCollection_A100/cublas_GemmEx_HF_TC/1024x1024x1024
# mv -f traces/* ../ASIMTracesCollection_A100/cublas_GemmEx_HF_TC/1024x1024x1024

# echo $(date +%Y/%m/%d/%T)

# LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./cublas_GemmEx_HF_TC_example -m 2048 -n 2048 -k 2048
# mkdir ../ASIMTracesCollection_A100/cublas_GemmEx_HF_TC/2048x2048x2048
# mv -f traces/* ../ASIMTracesCollection_A100/cublas_GemmEx_HF_TC/2048x2048x2048
...
# mkdir ../ASIMTracesCollection_A100/cusparse_spmm_csr_HF_CC/512x512x13107x512
# mv -f traces/* ../ASIMTracesCollection_A100/cusparse_spmm_csr_HF_CC/512x512x13107x512
...
# mkdir ../ASIMTracesCollection_A100/cusparse_spmm_csr_HF_CC/1024x1024x52428x1024
# mv -f traces/* ../ASIMTracesCollection_A100/cusparse_spmm_csr_HF_CC/1024x1024x52428x1024
...
# mkdir ../ASIMTracesCollection_A100/cusparse_spmm_csr_HF_CC/2048x2048x209716x2048
# mv -f traces/* ../ASIMTracesCollection_A100/cusparse_spmm_csr_HF_CC/2048x2048x209716x2048
...
# mkdir ../ASIMTracesCollection_A100/cusparse_spmm_csr_HF_CC/4096x4096x838860x4096
# mv -f traces/* ../ASIMTracesCollection_A100/cusparse_spmm_csr_HF_CC/4096x4096x838860x4096
...
trace_save_dir=../../../ASIMTracesCollection_A100/PolyBench/2DCONV
...
trace_save_dir=../../../ASIMTracesCollection_A100/PolyBench/3DCONV
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/PolyBench/3MM
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/PolyBench/ATAX
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/PolyBench/BICG
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/PolyBench/GEMM
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/PolyBench/GESUMMV
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/PolyBench/GRAMSCHM
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/PolyBench/MVT
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/b+tree
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/backprop
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/bfs
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/cfd
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/dwt2d
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/gaussian
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/hotspot
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/hotspot3D
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/huffman
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/lavaMD
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/lud
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/nn
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/nw
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Rodinia/pathfinder
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
# trace_save_dir=../ASIMTracesCollection_A100/sputnik_spmm_csr_HF_CC/512x512x13107x512
# mkdir $trace_save_dir
# mv -f traces/* $trace_save_dir
...
# trace_save_dir=../ASIMTracesCollection_A100/sputnik_spmm_csr_HF_CC/1024x1024x52428x1024
# mkdir $trace_save_dir
# mv -f traces/* $trace_save_dir
...
# trace_save_dir=../ASIMTracesCollection_A100/sputnik_spmm_csr_HF_CC/2048x2048x209716x2048
# mkdir $trace_save_dir
# mv -f traces/* $trace_save_dir
...
# trace_save_dir=../ASIMTracesCollection_A100/sputnik_spmm_csr_HF_CC/4096x4096x838860x4096
# mkdir $trace_save_dir
# mv -f traces/* $trace_save_dir
...
# trace_save_dir=../ASIMTracesCollection_A100/vectorSparse_spmm_csr_HF_TC/512x512x13107x512
# mkdir $trace_save_dir
# mv -f traces/* $trace_save_dir
...
# trace_save_dir=../ASIMTracesCollection_A100/vectorSparse_spmm_csr_HF_TC/1024x1024x52428x1024
# mkdir $trace_save_dir
# mv -f traces/* $trace_save_dir
...
# trace_save_dir=../ASIMTracesCollection_A100/vectorSparse_spmm_csr_HF_TC/2048x2048x209716x2048
# mkdir $trace_save_dir
# mv -f traces/* $trace_save_dir
...
# trace_save_dir=../ASIMTracesCollection_A100/vectorSparse_spmm_csr_HF_TC/4096x4096x838860x4096
# mkdir $trace_save_dir
# mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../../ASIMTracesCollection_A100/DeepBench/conv_bench_inference_halfx700x161x1x1x32x20x5x0x0x2x2
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
# trace_save_dir=../../../../ASIMTracesCollection_A100/DeepBench/conv_bench_train_halfx700x161x1x1x32x20x5x0x0x2x2
# mkdir $trace_save_dir
# mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../../ASIMTracesCollection_A100/DeepBench/gemm_bench_inference_halfx1760x7000x1760x0x0
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../../ASIMTracesCollection_A100/DeepBench/gemm_bench_train_halfx1760x7000x1760x0x0
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../../ASIMTracesCollection_A100/DeepBench/rnn_bench_inference_halfx1024x1x25xlstm
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../../ASIMTracesCollection_A100/DeepBench/rnn_bench_train_halfx1024x1x25xlstm
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Tango/AlexNet
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
# trace_save_dir=../../../ASIMTracesCollection_A100/Tango/CifarNet
# mkdir $trace_save_dir
# mv -f traces/* $trace_save_dir

cd $apps_root/Tango/GPU/GRU
LD_PRELOAD=../../../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./GRU
trace_save_dir=../../../ASIMTracesCollection_A100/Tango/GRU
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Tango/LSTM
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
# trace_save_dir=../../../ASIMTracesCollection_A100/Tango/ResNet
# mkdir $trace_save_dir
# mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/Tango/SqueezeNet
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../../../ASIMTracesCollection_A100/LULESH/cuda
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
trace_save_dir=../ASIMTracesCollection_A100/PENNANT
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
...
LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./bc/bc data/bc/data/2k_1M.gr
trace_save_dir=../ASIMTracesCollection_A100/pannotia/bc
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir

LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./color/color_max data/color_max/data/G3_circuit.graph 1
trace_save_dir=../ASIMTracesCollection_A100/pannotia/color_max
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir

LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./color/color_maxmin data/color_maxmin/data/G3_circuit.graph 1
trace_save_dir=../ASIMTracesCollection_A100/pannotia/color_maxmin
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir

LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./fw/fw data/fw/data/256_16384.gr
trace_save_dir=../ASIMTracesCollection_A100/pannotia/fw
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir

LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./mis/mis data/mis/data/G3_circuit.graph 1
trace_save_dir=../ASIMTracesCollection_A100/pannotia/mis
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir

LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./pagerank/pagerank data/pagerank/data/coAuthorsDBLP.graph 1
trace_save_dir=../ASIMTracesCollection_A100/pannotia/pagerank
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir

LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./pagerank/pagerank_spmv data/pagerank_spmv/data/coAuthorsDBLP.graph 1
trace_save_dir=../ASIMTracesCollection_A100/pannotia/pagerank_spmv
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir

LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./sssp/sssp data/sssp/data/USA-road-d.NY.gr 0
trace_save_dir=../ASIMTracesCollection_A100/pannotia/sssp
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir

LD_PRELOAD=../../util/tracer_nvbit/tracer_tool/tracer_tool.so ./sssp/sssp_ell data/sssp_ell/data/USA-road-d.NY.gr 0
trace_save_dir=../ASIMTracesCollection_A100/pannotia/sssp_ell
mkdir $trace_save_dir
mv -f traces/* $trace_save_dir
