...
cd $apps_root
# rm -rf ./OursTracesCollection
mkdir ./OursTracesCollection

mkdir ./OursTracesCollection/cublas_GemmEx_HF_CC
# mkdir ./OursTracesCollection/cublas_GemmEx_HF_TC
# mkdir ./OursTracesCollection/cusparse_spmm_csr_HF_CC
mkdir ./OursTracesCollection/PolyBench
mkdir ./OursTracesCollection/Rodinia
# mkdir ./OursTracesCollection/sputnik_spmm_csr_HF_CC
# mkdir ./OursTracesCollection/vectorSparse_spmm_csr_HF_TC
mkdir ./OursTracesCollection/DeepBench
mkdir ./OursTracesCollection/Tango
mkdir ./OursTracesCollection/LULESH
mkdir ./OursTracesCollection/PENNANT
...
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_CC/128x128x128
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_CC/128x128x128

# LD_PRELOAD=../../tracing_tool/tracer.so ./cublas_GemmEx_HF_CC_example -m 256 -n 256 -k 256
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_CC/256x256x256
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_CC/256x256x256

# LD_PRELOAD=../../tracing_tool/tracer.so ./cublas_GemmEx_HF_CC_example -m 512 -n 512 -k 512
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_CC/512x512x512
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_CC/512x512x512

# LD_PRELOAD=../../tracing_tool/tracer.so ./cublas_GemmEx_HF_CC_example -m 1024 -n 1024 -k 1024
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_CC/1024x1024x1024
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_CC/1024x1024x1024

LD_PRELOAD=../../tracing_tool/tracer.so ./cublas_GemmEx_HF_CC_example -m 2048 -n 2048 -k 2048
mkdir ../OursTracesCollection/cublas_GemmEx_HF_CC/2048x2048x2048
mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_CC/2048x2048x2048

# LD_PRELOAD=../../tracing_tool/tracer.so ./cublas_GemmEx_HF_CC_example -m 4096 -n 4096 -k 4096
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_CC/4096x4096x4096
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_CC/4096x4096x4096

# LD_PRELOAD=../../tracing_tool/tracer.so ./cublas_GemmEx_HF_CC_example -m 8192 -n 8192 -k 8192
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_CC/8192x8192x8192
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_CC/8192x8192x8192
...
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_TC/128x128x128
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_TC/128x128x128

# LD_PRELOAD=../../tracing_tool/tracer.so ./cublas_GemmEx_HF_TC_example -m 256 -n 256 -k 256
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_TC/256x256x256
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_TC/256x256x256

# LD_PRELOAD=../../tracing_tool/tracer.so ./cublas_GemmEx_HF_TC_example -m 512 -n 512 -k 512
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_TC/512x512x512
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_TC/512x512x512

# LD_PRELOAD=../../tracing_tool/tracer.so ./cublas_GemmEx_HF_TC_example -m 1024 -n 1024 -k 1024
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_TC/1024x1024x1024
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_TC/1024x1024x1024

# LD_PRELOAD=../../tracing_tool/tracer.so ./cublas_GemmEx_HF_TC_example -m 2048 -n 2048 -k 2048
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_TC/2048x2048x2048
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_TC/2048x2048x2048

# LD_PRELOAD=../../tracing_tool/tracer.so ./cublas_GemmEx_HF_TC_example -m 4096 -n 4096 -k 4096
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_TC/4096x4096x4096
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_TC/4096x4096x4096

# LD_PRELOAD=../../tracing_tool/tracer.so ./cublas_GemmEx_HF_TC_example -m 8192 -n 8192 -k 8192
# mkdir ../OursTracesCollection/cublas_GemmEx_HF_TC/8192x8192x8192
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cublas_GemmEx_HF_TC/8192x8192x8192
...
# mkdir ../OursTracesCollection/cusparse_spmm_csr_HF_CC/512x512x13107x512
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cusparse_spmm_csr_HF_CC/512x512x13107x512
...
# mkdir ../OursTracesCollection/cusparse_spmm_csr_HF_CC/1024x1024x52428x1024
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cusparse_spmm_csr_HF_CC/1024x1024x52428x1024
...
# mkdir ../OursTracesCollection/cusparse_spmm_csr_HF_CC/2048x2048x209716x2048
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cusparse_spmm_csr_HF_CC/2048x2048x209716x2048
...
# mkdir ../OursTracesCollection/cusparse_spmm_csr_HF_CC/4096x4096x838860x4096
# mv -f memory_traces/ sass_traces/ configs/ ../OursTracesCollection/cusparse_spmm_csr_HF_CC/4096x4096x838860x4096
...
trace_save_dir=../../../OursTracesCollection/PolyBench/2DCONV
...
trace_save_dir=../../../OursTracesCollection/Rodinia/hotspot
mkdir $trace_save_dir
mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir
...
# trace_save_dir=../OursTracesCollection/sputnik_spmm_csr_HF_CC/512x512x13107x512
# mkdir $trace_save_dir
# mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir
...
# trace_save_dir=../OursTracesCollection/sputnik_spmm_csr_HF_CC/1024x1024x52428x1024
# mkdir $trace_save_dir
# mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir
...
# trace_save_dir=../OursTracesCollection/sputnik_spmm_csr_HF_CC/2048x2048x209716x2048
# mkdir $trace_save_dir
# mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir
...
# trace_save_dir=../OursTracesCollection/sputnik_spmm_csr_HF_CC/4096x4096x838860x4096
# mkdir $trace_save_dir
# mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir
...
# trace_save_dir=../OursTracesCollection/vectorSparse_spmm_csr_HF_TC/512x512x13107x512
# mkdir $trace_save_dir
# mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir
...
# trace_save_dir=../OursTracesCollection/vectorSparse_spmm_csr_HF_TC/1024x1024x52428x1024
# mkdir $trace_save_dir
# mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir
...
# trace_save_dir=../OursTracesCollection/vectorSparse_spmm_csr_HF_TC/2048x2048x209716x2048
# mkdir $trace_save_dir
# mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir
...
# trace_save_dir=../OursTracesCollection/vectorSparse_spmm_csr_HF_TC/4096x4096x838860x4096
# mkdir $trace_save_dir
# mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir
...
trace_save_dir=../../../../OursTracesCollection/DeepBench/conv_bench_inference_halfx700x161x1x1x32x20x5x0x0x2x2
mkdir $trace_save_dir
mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir

# LD_PRELOAD=../../../../../tracing_tool/tracer.so ./conv_bench train half 700 161 1 1 32 20 5 0 0 2 2
# trace_save_dir=../../../../OursTracesCollection/DeepBench/conv_bench_train_halfx700x161x1x1x32x20x5x0x0x2x2
# mkdir $trace_save_dir
# mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir

LD_PRELOAD=../../../../../tracing_tool/tracer.so ./gemm_bench inference half 1760 7000 1760 0 0
trace_save_dir=../../../../OursTracesCollection/DeepBench/gemm_bench_inference_halfx1760x7000x1760x0x0
mkdir $trace_save_dir
mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir

LD_PRELOAD=../../../../../tracing_tool/tracer.so ./gemm_bench train half 1760 7000 1760 0 0
trace_save_dir=../../../../OursTracesCollection/DeepBench/gemm_bench_train_halfx1760x7000x1760x0x0
mkdir $trace_save_dir
mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir

LD_PRELOAD=../../../../../tracing_tool/tracer.so ./rnn_bench inference half 1024 1 25 lstm
trace_save_dir=../../../../OursTracesCollection/DeepBench/rnn_bench_inference_halfx1024x1x25xlstm
mkdir $trace_save_dir
mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir

LD_PRELOAD=../../../../../tracing_tool/tracer.so ./rnn_bench train half 1024 1 25 lstm
trace_save_dir=../../../../OursTracesCollection/DeepBench/rnn_bench_train_halfx1024x1x25xlstm
mkdir $trace_save_dir
mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir
...
trace_save_dir=../../../OursTracesCollection/LULESH/cuda
mkdir $trace_save_dir
mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir
...
trace_save_dir=../OursTracesCollection/PENNANT
mkdir $trace_save_dir
mv -f memory_traces/ sass_traces/ configs/ $trace_save_dir
