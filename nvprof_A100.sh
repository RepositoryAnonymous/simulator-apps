...
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./cublas_GemmEx_HF_CC_example_128x128x128 \
...
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./cublas_GemmEx_HF_CC_example_256x256x256 \
#          --force-overwrite --target-processes application-only --devices 0 --set full \
...
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./cublas_GemmEx_HF_CC_example_512x512x512 \
#          --force-overwrite --target-processes application-only --devices 0 --set full \
...
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./cublas_GemmEx_HF_CC_example_1024x1024x1024 \
#          --force-overwrite --target-processes application-only --devices 0 --set full \
...
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./cublas_GemmEx_HF_TC_example_128x128x128 \
#          --force-overwrite --target-processes application-only --devices 0 --set full \
...
# # 95% zero
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./cusparse_spmm_csr_HF_CC_example_512x512x13107x512 \
#          --force-overwrite --target-processes application-only --devices 0 --set full \
...
# # 95% zero
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./cusparse_spmm_csr_HF_CC_example_1024x1024x52428x1024 \
#          --force-overwrite --target-processes application-only --devices 0 --set full \
...
# # 95% zero
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./cusparse_spmm_csr_HF_CC_example_2048x2048x209716x2048 \
#          --force-overwrite --target-processes application-only --devices 0 --set full \
...
# # 95% zero
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./cusparse_spmm_csr_HF_CC_example_4096x4096x838860x4096 \
#          --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./2DConvolution \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./2DConvolution.exe"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./3DConvolution \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./3DConvolution.exe"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./3mm \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./3mm.exe"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./atax \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./atax.exe"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./bicg \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./bicg.exe"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./gemm \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./gemm.exe"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./gesummv \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./gesummv.exe"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./gramschmidt \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./gramschmidt.exe"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./mvt \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./mvt.exe"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./b+tree \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./backprop \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./backprop 65536"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./bfs \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./cfd \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./dwt2d \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./gaussian \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./hotspot \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./hotspot3D \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./huffman \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./lavaMD \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./lavaMD -boxes1d 10"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./lud \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./nn \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./nw \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./needle 2048 10"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./pathfinder \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./sputnik_spmm_csr_HF_CC_512x512x13107x512 \
#          --force-overwrite --target-processes application-only --devices 0 --set full \
...
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./vectorSparse_spmm_csr_HF_TC_512x512x13107x512 \
#          --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./conv_bench_inference_halfx700x161x1x1x32x20x5x0x0x2x2 \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./AN_32 \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./AN 32"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./CN_32 \
#          --force-overwrite --target-processes application-only --devices 0 --set full \
# 	     ./CN 32"
# expect ../../../expect.expect "$ncu_cmd"
# chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./GRU \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./GRU"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./LSTM_32 \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./LSTM 32"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
# ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./RN \
#          --force-overwrite --target-processes application-only --devices 0 --set full \
# 	     ./RN"
# expect ../../../expect.expect "$ncu_cmd"
# chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./SN_32 \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./SN 32"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./lulesh \
         --force-overwrite --target-processes application-only --devices 0 --set full \
	     ./lulesh -s 45"
expect ../../../expect.expect "$ncu_cmd"
chmod_cmd="chmod u+rw *.ncu-rep"
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./pennant \
         --force-overwrite --target-processes application-only --devices 0 --set full \
...
ncu_cmd="/usr/local/cuda-11.8/bin/ncu --export ./bc \
         --force-overwrite --target-processes application-only --devices 0 --set full \
